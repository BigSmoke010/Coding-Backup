...
class snake:
    ...
    def __init__(self):
        ...
        self.snacker = pygame.transform.scale(self.snacker,
                                              (cell_size, cell_size))
        self.snackright = pygame.image.load(
            'images/snakeheadright.png').convert_alpha()
        self.snackright = pygame.transform.scale(self.snackright,
                                                 (cell_size, cell_size))
        self.snackdown = pygame.image.load(
            'images/snakeheaddown.png').convert_alpha()
        self.snackdown = pygame.transform.scale(self.snackdown,
                                                (cell_size, cell_size))
        self.snackleft = pygame.image.load(
            'images/snakeheadleft.png').convert_alpha()
        self.snackleft = pygame.transform.scale(self.snackleft,
                                                (cell_size, cell_size))
        self.snake_body = pygame.image.load(
            'images/snakebody.png').convert_alpha()
        self.snake_body = pygame.transform.scale(self.snake_body,
                                                 (cell_size, cell_size))
    ...
    def drawsnake(self):
        ...
        for index, block in enumerate(self.body):
            snakblock = pygame.rect.Rect(block.x * cell_size,
...
class fruit:
    ...
    def drawfruit(self):
        apple = pygame.rect.Rect(self.pos.x * cell_size,
...
class titlescreen:
    ...
    def showtitle(self):
        ...
        screen.blit(
            font,
            (cell_size * cell_number / 2 - 180, cell_size * cell_number - 100))
